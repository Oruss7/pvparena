...
public class Config {
    ...
    public void addSpawn(PASpawn paSpawn) {
        this.setManually(PASpawn.serialize(paSpawn), parseToString(paSpawn.getPALocation()));
        this.save();
    }

    public void clearSpawn(String name, String teamName, String className){
        this.setManually(PASpawn.serialize(new PASpawn(null, name, teamName, className)), null);
        this.save();
    }
