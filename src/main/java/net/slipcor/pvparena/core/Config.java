...
public class Config {
    ...
    public enum CFG {
        ...
        GOAL_FLAGS_FLAG_STOLEN_SOUND("goal.flags.stolensound", "ENTITY_WITHER_AMBIENT", "Flags"),
        GOAL_FLAGS_FLAG_OWN_STOLEN_SOUND("goal.flags.stolensound", "ENTITY_WITHER_AMBIENT", "Flags"),
        GOAL_FLAGS_FLAG_STOLEN_PARTICLE("goal.flags.stoleneffect", "none", "Flags"),
        GOAL_FLAGS_FLAG_CAPTURED_SOUND("goal.flags.capturedsound", "ENTITY_EXPERIENCE_ORB_PICKUP", "Flags"),
        GOAL_FLAGS_FLAG_OWN_CAPTURED_SOUND("goal.flags.owncapturedsound", "ENTITY_EXPERIENCE_ORB_PICKUP", "Flags"),
        GOAL_FLAGS_FLAG_CAPTURED_PARTICLE("goal.flags.capturedeffect", "none", "Flags"),
        GOAL_FLAGS_FLAG_RELEASE_SOUND("goal.flags.releasesound", "none", "Flags"),
        GOAL_FLAGS_FLAG_OWN_RELEASE_SOUND("goal.flags.ownreleasesound", "none", "Flags"),
        GOAL_FLAGS_FLAG_RELEASE_PARTICLE("goal.flags.releaseeffect", "none", "Flags"),
