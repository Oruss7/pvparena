...
public final class Language {
    ...
    public enum MSG {
        ...
        ERROR_GOAL_REQUIRE_REGION_BATTLE("nulang.error.goal.regionbattlerequired", "A battle region is required."),
        ...
        WARN_MAT_NOT_COLORABLE("nulang.warn.log.matnotcolorable", "&fMaterial &e%1% &fis not colorable."),
        ...
        REGION_SELECT("nulang.region.select", "Select two points with your wand item %1%, left click first and then right click!"),
        ...
        SPAWN_REMOVED("nulang.spawn.removed", "Spawn removed: &a%1%&r %2% %3%"),
        SPAWN_SET("nulang.spawn.set", "Spawn set: &a%1%&r %2% %3%"),
        ...
        GOAL_SABOTAGE_SET_TNT("nulang.goal.sabotage.set", "TNT set: %1%"),
        GOAL_SABOTAGE_TO_SET_TNT("nulang.goal.sabotage.toset", "TNT to set: %1%"),
        GOAL_SABOTAGE_NO_SELF_DESTROY("nulang.goal.sabotage.noselfdestroy", "You can not ignite your own TNT!"),
        GOAL_SABOTAGE_NOT_GOOD_ITEM("nulang.goal.sabotage.notgooditem", "You need sabotage tool to ignite the TNT."),
        GOAL_SABOTAGE_YOU_CARRY_TNT("nulang.goal.sabotage.youtnt", "You now carry the sabotage tool."),
